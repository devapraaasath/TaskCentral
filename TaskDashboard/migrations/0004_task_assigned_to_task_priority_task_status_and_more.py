...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('TaskDashboard', '0003_user_is_staff'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='TaskDashboard.project'),
        ),
    ]
